		...
		<div className={styles.ticket_selection}>
			...
			<div className={styles.card}>
				<div className={styles.event_card}>
					...
					<p><FontAwesomeIcon icon={faLocationDot} /> [Event Location] || March 15, 2025|7:00 PM</p>
				</div>
				...
				<div className={styles.ticket_options}>
					...
					<div className={styles.ticket_option_item}>
						{ticketOptions.map((ticket) => (
							<button key={ticket.type} className={selectedTicket === ticket.type ? "active" : ""} onClick={() => setSelectedTicket(ticket.type)}>
				...
				<div className={styles.ticketselectbutton}>
					...
					<button className={styles.next}  onClick={() => navigate("/attendeedetails")} >Next</button>
				</div>
